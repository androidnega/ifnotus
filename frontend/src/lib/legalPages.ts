...
> = {
  ...
  terms: {
    ...
    body: [
      ...
      'Student addresses (surname.serverlabsttu.space) are included project hostnames. They are not a registered domain you can transfer away. Legacy student sites on *.ifnotus.space keep working.',
  ...
  nameservers: {
    ...
    updated: '19 August 2026',
    body: [
      'Point custom domains to ns1.ifnotus.space and ns2.ifnotus.space at your registrar. Do not use a server IP address.',
      ...
      'Student sites on *.serverlabsttu.space (and legacy *.ifnotus.space student hosts) already use IFNOTUS DNS. No nameserver change is needed.',
      'After you change nameservers, wait for DNS to update, then turn on HTTPS in your panel.',
    ],
  },
  pay: {
    title: 'How to pay',
    ...
    body: [
      ...
      'Open the invoice. Send the exact amount to the IFNOTUS MTN merchant number shown.',
