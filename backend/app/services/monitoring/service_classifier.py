...
KNOWN_SERVICES: dict[str, tuple[ServiceCategory, bool]] = {
    ...
    "docker": (ServiceCategory.SYSTEM, True),
    "containerd": (ServiceCategory.SYSTEM, True),
    "php8.3-fpm": (ServiceCategory.WEB, True),
    "php8.2-fpm": (ServiceCategory.WEB, True),
    "php8.1-fpm": (ServiceCategory.WEB, True),
    "postfix": (ServiceCategory.SYSTEM, True),
    "dovecot": (ServiceCategory.SYSTEM, True),
    "named": (ServiceCategory.SYSTEM, True),
    "bind9": (ServiceCategory.SYSTEM, True),
