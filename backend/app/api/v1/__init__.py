...
from app.routers.v1 import alerts, applications, auth, catalog, customers, dashboard, health, hosting, inventory, logs, monitoring, operations, platform_admin, processes, security, server, services, support
